...
/**
 * @description: <p>扩展 spring cloud ribbon的PropertiesFactory</p>
 *               <p>使其能够支持 配置全局的ribbon.NFLoadBalancerRuleClassName=package.YourRule</p>
 *               <p>然后各个微服务还可以根据自身情况做个性化定制。如:SERVICE_ID.ribbon.NFLoadBalancerRuleClassName=package.YourRule</p>
 * @author: hujie@umisoft.cn
 * @date: 2019/3/26 5:07 PM
 */
