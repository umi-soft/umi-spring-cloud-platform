...
INSERT INTO `T_USER`(`ID`, `DELETED`, `DISABLED`, `SORT_NUM`, `LOGIN_NAME`, `PASSWORD`, `NAME`, `NICK_NAME`, `AVATAR`, `ID_NUMBER`, `GENDER`, `BIRTHDAY`, `PHONE`, `EMAIL`, `ADDRESS`, `TAG`, `REMARK`, `CREATED_BY`, `CREATED_DATE`, `MODIFIED_BY`, `MODIFIED_DATE`) VALUES ('admin', 0, 0, '1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '2019-02-23 11:14:51', 'admin', '2019-03-10 03:40:59');
INSERT INTO `T_ROLE`(`ID`, `DELETED`, `SORT_NUM`, `NAME`, `REMARK`, `CREATED_BY`, `CREATED_DATE`, `MODIFIED_BY`, `MODIFIED_DATE`) VALUES ('admin', 0, 'ADMIN', 'ADMIN', '系统内置的超级角色', 'admin', '2019-03-09 23:43:50', 'admin', '2019-03-11 05:27:30');
